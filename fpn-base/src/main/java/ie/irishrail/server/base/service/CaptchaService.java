...
import ie.irishrail.server.base.jsonentity.GoogleResponse;
...
public class CaptchaService {
    ...
    public void processResponse(String response) throws FPNException {

        if (!responseSanityCheck(response))
            throw new FPNException(ServerResponseConstants.API_FAILURE_CODE, ServerResponseConstants.API_FAILURE_TEXT, "Captcha response contains invalid characters.");
        ...
        try {
            ...
            if (!googleResponse.getSuccess()) {
                ...
                throw new FPNException(ServerResponseConstants.API_FAILURE_CODE, ServerResponseConstants.API_FAILURE_TEXT, "Captcha was not successfully validated.");
            }
        } catch (RestClientException rce) {
            throw new FPNException(ServerResponseConstants.API_FAILURE_CODE, ServerResponseConstants.API_FAILURE_TEXT, "ReCaptcha service unavailable.");
        }
