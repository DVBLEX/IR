...
import ie.irishrail.server.base.repository.EmailConfigRepository;
import ie.irishrail.server.base.repository.EmailLogRepository;
import ie.irishrail.server.base.repository.EmailSchedulerRepository;
import ie.irishrail.server.base.repository.EmailTemplateRepository;
...
import ie.irishrail.server.base.entity.EmailLog;
...
public class EmailService {
    ...
    public void sendEmail(Email email) throws FPNException {
        ...
        try {
            ...
            throw new FPNException(ServerResponseConstants.INVALID_EMAIL_CODE, ServerResponseConstants.INVALID_EMAIL_TEXT + " To. " + e.getClass() + "###" + e.getMessage(),
    ...
    @Transactional
    public void scheduleEmailByType(Email email, long templateType, HashMap<String, Object> params) throws FPNException {
    ...
    private void sendEmail(Properties props, final String fromEmail, final String fromEmailPassword, InternetAddress[] addressTo, InternetAddress[] addressReplyTo,
        InternetAddress[] addressCc, InternetAddress[] addressBcc, String subject, String content, File attachment) throws FPNException {
        ...
        try {
            ...
            throw new FPNException(ServerResponseConstants.EXTERNAL_API_CONNECTION_FAILURE_CODE, e.getClass() + "###" + e.getMessage(), "sendEmail###Exception");
        }
    }

    private void updateEmailWithTemplateData(Email email, long templateType, HashMap<String, Object> params) throws FPNException {
    ...
    private Long createEmailLog(Email email) {
        ...
        emailLog.setAccountId(email.getAccountId());
