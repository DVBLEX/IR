...
public class ServerUtil {
    ...
    public static String getValidNumber(String numberString, String responseSource) throws FPNException {
        ...
        try {
            if (Long.parseLong(numberString) <= 0)
                throw new FPNException(ServerResponseConstants.INVALID_MSISDN_CODE, ServerResponseConstants.INVALID_MSISDN_TEXT, responseSource + "1#");
        } catch (Exception e) {
            throw new FPNException(ServerResponseConstants.INVALID_MSISDN_CODE, ServerResponseConstants.INVALID_MSISDN_TEXT, responseSource + "2#");
        }
