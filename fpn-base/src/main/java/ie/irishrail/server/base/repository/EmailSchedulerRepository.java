...
import ie.irishrail.server.base.entity.EmailScheduler;
...
public interface EmailSchedulerRepository extends CrudRepository<EmailScheduler, Long> {
    @Query("SELECT es.id, es.type, es.config_id, es.account_id, es.template_id, es.email_to, es.email_bcc, es.subject, es.message, es.attachment_path, es.date_scheduled, es.retry_count "
    ...
    @Modifying
    @Query("INSERT INTO email_scheduler(id, is_processed, type, config_id, account_id, template_id, priority, email_to, email_reply_to, email_bcc, subject, message, channel, attachment_path, date_created, "
        + "date_scheduled, retry_count, date_processed, response_code, response_text) "
        + "SELECT id, is_processed, type, config_id, account_id, template_id, priority, email_to, email_reply_to, email_bcc, subject, :message, channel, attachment_path, date_created, "
