...
public class MyUserDetails implements UserDetails {
    ...
    public MyUserDetails(long id, String code, String firstname, String lastname, String username, String password, boolean enabled, boolean isLocked,
        int loginFailureCount, int role, Date dateLastPassword, boolean isCredentialsExpired, Date dateLocked, int loginLockHours, int passwordValidDays) {
